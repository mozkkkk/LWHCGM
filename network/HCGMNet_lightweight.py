...
from network.MRA_com import MRA
...
class HCGMNet_light(nn.Module):
    def __init__(self,):
        super(HCGMNet_light, self).__init__()
        self.backbone = starnet_s2(pretrained=True)
        self.upsample = nn.Upsample(scale_factor=2, mode='nearest')

        self.mdattn1 = MRA(32,7,nn.BatchNorm2d)
        self.mdattn2 = MRA(64,7,nn.BatchNorm2d)
        self.mdattn3 = MRA(128,7,nn.BatchNorm2d)
        self.mdattn4 = MRA(256,7,nn.BatchNorm2d)
        ...
        self.conv_reduce_4 = BasicConv2d(256*2,256,3,1,1)

        self.conv_reduce_5 = BasicConv2d(32*3,32,3,1,1)
        self.conv_reduce_6 = BasicConv2d(64*3,64,3,1,1)
        self.conv_reduce_7 = BasicConv2d(128*3,128,3,1,1)
        self.conv_reduce_8 = BasicConv2d(256*3,256,3,1,1)
        ...
        self.cgm_2 = RetinalChangeGuideModule(64)
        self.cgm_3 = RetinalChangeGuideModule(128)
        self.cgm_4 = RetinalChangeGuideModule(256)
    ...
    def forward(self,A,B):
        ...
        layer1 = self.conv_reduce_5(layer1)
        layer2 = self.conv_reduce_6(layer2)
        layer3 = self.conv_reduce_7(layer3)
        layer4 = self.conv_reduce_8(layer4)
