...
from network.HCGMNet_lightweight import HCGMNet_light
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', type=str, default='HCGMNet_light', #修改这里！！！
                        help='the test rgb images root')
    ...
    if opt.data_name == 'LEVIR':
        ...
        opt.test_root = 'D:/BaiduNetdiskDownload/S2Looking/test/'

    elif opt.data_name == 'test':
        opt.test_root = 'D:/BaiduNetdiskDownload/test/'
    ...
    elif opt.model_name == 'HCGMNet_light':
        model = HCGMNet_light().cuda()
